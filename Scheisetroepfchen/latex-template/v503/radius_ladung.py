...
eta22_unk = 1.834e-5    # wird nicht benötigt
eta23_unk = 1.8375e-5
d = 7.6250e-4           # plattenabstand kondensator in metern
b = 82.3                # cunningham-faktor in pascal*meter
...
#
#r304 = np.sqrt((9*eta23*(vauf_304 - vab_304))/(2*g*(rho_oel - rho_luft)))
#
#print(r304)              #-------> sind eh alle messwerte ungültig lol, bei U = 3,97V genau so
...
print("-------------die ladungen der Tröpchen bei 2,20V. der erste und fünfte wert sind wichtig ", q220) # hier sind der erste und fünfte wert wichtig


q457 = 3*np.pi*eta21*np.sqrt((9*eta21*(vab_457-vauf_457))/(4*g*(rho_oel - rho_luft)))*((vab_457 + vauf_457)/E457)
print("-------------die ladungen der Tröpchen bei 4,57V. der vierte wert ist wichtig ", q457)    # hier ist der vierte wert wichtig


q491 = 3*np.pi*eta23_491*np.sqrt((9*eta23_491*(vab_491-vauf_491))/(4*g*(rho_oel - rho_luft)))*((vab_491 + vauf_491)/E491)
print("-------------die ladungen der Tröpchen bei 4,91V. der vierte wert ist wichtig ", q491)    # hier ist der vierte wert wichtig 
...
print("---------------- die korrigierte ladung bei 220V beträgt, erster und fünfter wert", q220_korr)
